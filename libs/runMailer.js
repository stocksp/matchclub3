            ...
            resp = await nodemailerMailgun.sendMail({
              ...
              html:
               ...
               <p>This is a reminder that you are signed up for the match with ${
                ...
                <h6><p style=\"color:#007777\">If you would like to have these reminders sent to another email address, or would like to change the scheduling, please logon to the MatchClub site and change the reminder settings in the Members tab.</p></h6>
               </html>`,
            });
          } else {
